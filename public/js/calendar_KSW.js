...
!function() {
    ...
    Calendar.prototype.openDay = function(el) {
        ...
        if(currentOpened && currentOpened.parentNode === el.parentNode) {
            ...
            eventarrow= document.querySelector('.eventarrow');
        } else {
            ...
            //Create the arrow
            var eventarrow = createElement('div', 'eventarrow');

            //Create the event wrapper

            details.appendChild(eventarrow);
        ...
        eventarrow.style.left = el.offsetLeft - el.parentNode.offsetLeft + 27 + 'px';
    }
    ...
    Calendar.prototype.renderEvents = function(events, ele) {
        ...
        events.forEach(function(ev) {
            ...
            span .setAttribute("href", "Home_KSW.html")
